// -*- C++ -*-
//===--------------- char16.t (from libc++ original code) -----------------===//
//
...
#ifndef WRUTIL_CODECVT_CHAR16_H
#define WRUTIL_CODECVT_CHAR16_H
...
template <>
class WRUTIL_API codecvt<char16_t, char, mbstate_t>
    : public locale::facet,
      public codecvt_base
{
public:
...
#endif // !WR_HAVE_STD_CODECVT_CHAR16
#endif // !WRUTIL_CODECVT_CHAR16_H
